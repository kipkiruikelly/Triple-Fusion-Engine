...
def migrate_all():
    ...
    if _table_exists(conn, "user"):
        ...
        for row in user_rows:
            ...
            user, created = User.objects.get_or_create(username=username, defaults={
                ...
                'is_active': _get(row, 'status', 'active') != 'deactivated',
            })
            if not created:
                # Update fields
    ...
    if _table_exists(conn, "ticker_config"):
    ...
    if _table_exists(conn, "watchlist_item"):
    ...
    if _table_exists(conn, "portfolio_position"):
    ...
    if _table_exists(conn, "notification"):
    ...
    if _table_exists(conn, "gift_code"):
    ...
    if _table_exists(conn, "pyth_feed"):
    ...
    if _table_exists(conn, "paper_trade"):
        ...
        if _table_exists(conn, "paper_equity_snapshot"):
        ...
        if _table_exists(conn, "paper_trade_event"):
